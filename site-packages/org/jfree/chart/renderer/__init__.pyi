...
class GrayPaintScale(PaintScale, org.jfree.util.PublicCloneable, java.io.Serializable):
    def __init__(self) -> None: ...
...
class LookupPaintScale(PaintScale, org.jfree.util.PublicCloneable, java.io.Serializable):
    def __init__(self) -> None: ...
