...
class DefaultKeyedValue(KeyedValue, java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable', java.io.Serializable):
    def __init__(self, k: 'K', j: java.lang.Number) -> None: ...
...
class KeyedValues(Values):
    ...
    def getIndex(self, k: 'K') -> int: ...
    
    def getKey(self, i: int) -> 'K': ...
    
    def getKeys(self) -> typing.List['K']: ...
    
    
class DefaultKeyedValues(KeyedValues, java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable', java.io.Serializable):
    def __init__(self) -> None: ...
    
    def addValue(self, k: 'K', f: float) -> None: ...
    ...
    def insertValue(self, i: int, k: 'K', f: float) -> None: ...
    
    def removeValue(self, i: int) -> None: ...
    
    def setValue(self, k: 'K', f: float) -> None: ...
    
    def sortByKeys(self, o: 'org.jfree.chart.util.SortOrder') -> None: ...
    
    def sortByValues(self, o: 'org.jfree.chart.util.SortOrder') -> None: ...
...
class DefaultKeyedValues2D(KeyedValues2D, 'org.jfree.chart.util.PublicCloneable', java.lang.Cloneable, java.io.Serializable):
    def __init__(self) -> None: ...
...
class KeyToGroupMap(java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable', java.io.Serializable):
    def __init__(self) -> None: ...
...
class KeyedObject(java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable', java.io.Serializable):
    def __init__(self, j: java.lang.Comparable, o: object) -> None: ...
...
class KeyedObjects(java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable', java.io.Serializable):
    def __init__(self) -> None: ...
...
class KeyedValueComparator(java.util.Comparator, java.io.Serializable):
    def __init__(self, keyedValueComparatorType: 'KeyedValueComparatorType', o: 'org.jfree.chart.util.SortOrder') -> None: ...
    
    def compare(self, o: object, o2: object) -> int: ...
    
    def getOrder(self) -> 'org.jfree.chart.util.SortOrder': ...
    
    def getType(self) -> 'KeyedValueComparatorType': ...
    
    
class KeyedValueComparatorType(java.io.Serializable):
...
class KeyedValues2DItemKey(ItemKey, java.lang.Comparable, java.io.Serializable):
    def __init__(self, r: 'R', c: 'C') -> None: ...
    
    def compareTo(self, t: typing.Any) -> int: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getColumnKey(self) -> 'C': ...
    
    def getRowKey(self) -> 'R': ...
...
class KeyedValuesItemKey(ItemKey, java.io.Serializable):
...
class Range(java.io.Serializable):
    ...
    @staticmethod
    def combineIgnoringNaN(range: 'Range', range2: 'Range') -> 'Range': ...
