...
class RegularTimePeriod(TimePeriod, java.lang.Comparable, org.jfree.date.MonthConstants):
    APRIL = 4
    AUGUST = 8
    DECEMBER = 12
    DEFAULT_TIME_ZONE = 'sun.util.calendar.ZoneInfo[id="America/Los_Angeles",offset=-28800000,dstSavings=3600000,useDaylight=true,transitions=185,lastRule=java.util.SimpleTimeZone[id=America/Los_Angeles,offset=-28800000,dstSavings=3600000,useDaylight=true,startYear=0,startMode=3,startMonth=2,startDay=8,startDayOfWeek=1,startTime=7200000,startTimeMode=0,endMode=3,endMonth=10,endDay=1,endDayOfWeek=1,endTime=7200000,endTimeMode=0]]'
    FEBRUARY = 2
    JANUARY = 1
    JULY = 7
    JUNE = 6
    ...
    OCTOBER = 10
    SEPTEMBER = 9
    WORKING_CALENDAR = 'java.util.GregorianCalendar[time=1674410665769,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="America/Los_Angeles",offset=-28800000,dstSavings=3600000,useDaylight=true,transitions=185,lastRule=java.util.SimpleTimeZone[id=America/Los_Angeles,offset=-28800000,dstSavings=3600000,useDaylight=true,startYear=0,startMode=3,startMonth=2,startDay=8,startDayOfWeek=1,startTime=7200000,startTimeMode=0,endMode=3,endMonth=10,endDay=1,endDayOfWeek=1,endTime=7200000,endTimeMode=0]],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2023,MONTH=0,WEEK_OF_YEAR=4,WEEK_OF_MONTH=4,DAY_OF_MONTH=22,DAY_OF_YEAR=22,DAY_OF_WEEK=1,DAY_OF_WEEK_IN_MONTH=4,AM_PM=0,HOUR=10,HOUR_OF_DAY=10,MINUTE=4,SECOND=25,MILLISECOND=769,ZONE_OFFSET=-28800000,DST_OFFSET=0]'
    
    def __init__(self) -> None: ...
    
    @staticmethod
    def createInstance(j: java.lang.Class, j2: java.util.Date, j3: java.util.TimeZone) -> 'RegularTimePeriod': ...
...
class Day(RegularTimePeriod, java.io.Serializable):
    ...
    def getSerialDate(self) -> org.jfree.date.SerialDate: ...
...
class TimeSeriesCollection(org.jfree.data.xy.AbstractIntervalXYDataset, org.jfree.data.DomainInfo):
    pass
...
class TimeTableXYDataset(org.jfree.data.xy.AbstractIntervalXYDataset, org.jfree.util.PublicCloneable, org.jfree.data.DomainInfo, org.jfree.data.xy.TableXYDataset):
    pass
