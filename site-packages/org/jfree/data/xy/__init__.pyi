...
class CategoryTableXYDataset(AbstractIntervalXYDataset, TableXYDataset, org.jfree.data.DomainInfo, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class OHLCDataset(XYDataset):
    pass
    
class DefaultHighLowDataset(AbstractXYDataset, OHLCDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class DefaultIntervalXYDataset(AbstractIntervalXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class DefaultOHLCDataset(AbstractXYDataset, OHLCDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class DefaultTableXYDataset(AbstractIntervalXYDataset, TableXYDataset, org.jfree.data.DomainInfo, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class WindDataset(XYDataset):
    pass
    
class DefaultWindDataset(AbstractXYDataset, WindDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class DefaultXYDataset(AbstractXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class DefaultXYZDataset(AbstractXYZDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class IntervalXYDelegate(org.jfree.data.general.DatasetChangeListener, org.jfree.data.DomainInfo, java.io.Serializable, java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable'):
...
class MatrixSeriesCollection(AbstractXYZDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class VectorSeriesCollection(AbstractXYDataset, VectorXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class XIntervalSeriesCollection(AbstractIntervalXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class XYBarDataset(AbstractIntervalXYDataset, org.jfree.data.general.DatasetChangeListener, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class XYIntervalSeriesCollection(AbstractIntervalXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class XYItemKey(org.jfree.data.ItemKey, java.lang.Comparable, java.io.Serializable):
    def __init__(self, s: 'S', i: int) -> None: ...
    
    def compareTo(self, t: typing.Any) -> int: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getItemIndex(self) -> int: ...
    
    def getSeriesKey(self) -> 'S': ...
...
class XYSeriesCollection(AbstractIntervalXYDataset, org.jfree.data.DomainInfo, org.jfree.data.RangeInfo, java.beans.VetoableChangeListener, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class YIntervalSeriesCollection(AbstractIntervalXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
