...
class BoxAndWhiskerItem(java.io.Serializable):
    def __init__(self, f: float, f2: float, f3: float, f4: float, f5: float, f6: float, f7: float, f8: float, t: typing.List['java.lang.Number']) -> None: ...
    ...
    def getOutliers(self) -> typing.List[java.lang.Number]: ...
...
class DefaultBoxAndWhiskerCategoryDataset(BoxAndWhiskerCategoryDataset, org.jfree.data.general.AbstractDataset, org.jfree.data.RangeInfo, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class DefaultMultiValueCategoryDataset(MultiValueCategoryDataset, org.jfree.data.general.AbstractDataset, org.jfree.data.RangeInfo, 'org.jfree.chart.util.PublicCloneable'):
    pass
    
class StatisticalCategoryDataset(org.jfree.data.category.CategoryDataset):
    pass
    
class DefaultStatisticalCategoryDataset(StatisticalCategoryDataset, org.jfree.data.general.AbstractDataset, org.jfree.data.RangeInfo, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class HistogramDataset(org.jfree.data.xy.AbstractIntervalXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
...
class Regression:
    ...
    @staticmethod
    def getPolynomialRegression(o: org.jfree.data.xy.XYDataset, i: int, i2: int) -> typing.List[float]: ...
    
    @staticmethod
    def getPowerRegression(t: typing.List[typing.List[float]]) -> typing.List[float]: ...
    
    
class SimpleHistogramBin(java.lang.Comparable, java.lang.Cloneable, 'org.jfree.chart.util.PublicCloneable', java.io.Serializable):
    def __init__(self, f: float, f2: float) -> None: ...
...
class SimpleHistogramDataset(org.jfree.data.xy.AbstractIntervalXYDataset, 'org.jfree.chart.util.PublicCloneable'):
    pass
