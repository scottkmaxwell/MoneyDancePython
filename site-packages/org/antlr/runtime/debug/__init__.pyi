...
class DebugEventListener:
    ...
    def enterDecision(self, i: int, b: bool) -> None: ...
...
class Profiler(BlankDebugEventListener):
    ...
    def examineRuleMemoization(self, o: org.antlr.runtime.IntStream, i: int, i2: int, s: str) -> None: ...
    
    def exitDecision(self, i: int) -> None: ...
    
    def exitRule(self, s: str, s2: str) -> None: ...
    
    def getDecisionEvents(self) -> typing.List[str]: ...
    
    def getDecisionStats(self) -> typing.Any: ...
    
    def getDecisionStatsDump(self) -> str: ...
    ...
    class DecisionEvent:
        backtracks: bool
        decision: 'Profiler.DecisionDescriptor'
        evalSemPred: bool
        k: int
    ...
    class ProfileStats:
        Version: str
        averageDecisionPercentBacktracks: float
        avgDecisionMaxCyclicLookaheads: int
        avgDecisionMaxFixedLookaheads: int
        avgkPerBacktrackingDecisionEvent: float
        avgkPerDecisionEvent: float
        maxDecisionMaxCyclicLookaheads: int
        maxDecisionMaxFixedLookaheads: int
        maxRuleInvocationDepth: int
        minDecisionMaxCyclicLookaheads: int
        minDecisionMaxFixedLookaheads: int
        name: str
        numBacktrackOccurrences: int
        numCharsMatched: int
        numCyclicDecisions: int
        numDecisionEvents: int
        numDecisionsCovered: int
        numDecisionsThatDoBacktrack: int
        numDecisionsThatPotentiallyBacktrack: int
        ...
        numMemoizationCacheHits: int
        numMemoizationCacheMisses: int
        numReportedErrors: int
        numRuleInvocations: int
        numSemanticPredicates: int
        numTokens: int
        numUniqueRulesInvoked: int
        stddevDecisionMaxCyclicLookaheads: int
        stddevDecisionMaxFixedLookaheads: int
