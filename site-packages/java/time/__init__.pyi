...
class LocalDate('temporal.Temporal', 'temporal.TemporalAdjuster', 'chrono.ChronoLocalDate', java.io.Serializable):
    ...
    def minus(self, t: 'temporal.TemporalAmount') -> 'temporal.Temporal': ...
    ...
    def until(self, c: 'chrono.ChronoLocalDate') -> 'chrono.ChronoPeriod': ...
    
    def with(self, t: 'temporal.TemporalAdjuster') -> 'chrono.ChronoLocalDate': ...
...
class Period('chrono.ChronoPeriod', java.io.Serializable):
    ...
    def multipliedBy(self, i: int) -> 'Period': ...
