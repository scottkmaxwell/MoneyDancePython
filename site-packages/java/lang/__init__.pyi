...
class String(Object, Comparable, CharSequence, java.io.Serializable, 'constant.Constable', 'constant.ConstantDesc'):
    ...
    def resolveConstantDesc(self, s: str) -> str: ...
...
class StringBuilder(AbstractStringBuilder, Comparable, java.io.Serializable):
    ...
    def appendCodePoint(self, i: int) -> 'StringBuilder': ...
    ...
    def delete(self, i: int, i2: int) -> AbstractStringBuilder: ...
    ...
    def replace(self, i: int, i2: int, s: str) -> AbstractStringBuilder: ...
