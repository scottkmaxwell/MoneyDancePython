...
class SyncRecord(dict):
    ...
    def getByteArray(self, s: str) -> typing.List[int]: ...
    
    def getDouble(self, s: str, f: float) -> float: ...
    
    def getInt(self, s: str, i: int) -> int: ...
    
    def getIntArray(self, s: str) -> typing.List[int]: ...
    ...
    def getStringList(self, s: str) -> typing.List[str]: ...
    
    def getSublist(self, s: str) -> typing.List['SyncRecord']: ...
    ...
    def putAllFromMap(self, d: dict, t: typing.List[object]) -> None: ...
    ...
    @staticmethod
    def unescapeAndDecodeUTF8(t: typing.List[int], i: int, i2: int) -> str: ...
    
    def writeSet(self, j: java.io.Writer) -> None: ...
    
    def writeToBytes(self) -> typing.List[int]: ...
...
class SyncableDoc:
    ...
    def allItems(self) -> typing.List['SyncableItem']: ...
