...
class FlexibleDateParser:
    def __init__(self, importDateFieldOrder: 'ImportDateFieldOrder', s: str) -> None: ...
    
    def getActualDateFieldOrder(self) -> 'ImportDateFieldOrder': ...
    
    def getOriginalValues(self) -> typing.List[str]: ...
...
class ImportDataSourceType(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['ImportDataSourceType']: ...
...
class ImportDateFieldOrder(java.lang.Enum):
    ...
    @staticmethod
    def allFields() -> typing.List['ImportDateFieldOrder']: ...
    
    @staticmethod
    def fromLocale() -> 'ImportDateFieldOrder': ...
    
    def getDateFieldList(self) -> typing.List[str]: ...
    ...
    @staticmethod
    def values() -> typing.List['ImportDateFieldOrder']: ...
...
class ImportFieldType(java.lang.Enum):
    ...
    @staticmethod
    def allFields() -> typing.List['ImportFieldType']: ...
    
    @staticmethod
    def defaultImportFields() -> typing.List['ImportFieldType']: ...
    ...
    @staticmethod
    def values() -> typing.List['ImportFieldType']: ...
    
    
class TabularTextImportSpec:
    IMPORTABLE_ACCOUNTS_FILTER = 'com.infinitekind.moneydance.model.txtimport.TabularTextImportSpec$1'
    ...
    def getDecimalPoint(self) -> str: ...
    
    def getDelimiter(self) -> str: ...
    
    def getFields(self) -> typing.List[ImportFieldType]: ...
    ...
    def setDecimalPoint(self, s: str) -> None: ...
    
    def setDelimiter(self, s: str) -> None: ...
    
    def setFields(self, t: typing.List[ImportFieldType]) -> None: ...
...
class TabularTextImporter:
    ...
    def __init__(self, c: com.infinitekind.moneydance.model.AccountBook, tabularTextImportSpec: TabularTextImportSpec) -> None: ...
