...
class AccountBook:
    ...
    def getCheckpointFiles(self) -> typing.List[java.io.File]: ...
    ...
    def getItemsWithType(self, s: str) -> typing.List[com.infinitekind.tiksync.SyncableItem]: ...
    ...
    def logModifiedItems(self, t: typing.List[MoneydanceSyncableItem]) -> bool: ...
    
    def logRemovedItem(self, moneydanceSyncableItem: MoneydanceSyncableItem) -> bool: ...
    
    def logRemovedItems(self, t: typing.List[MoneydanceSyncableItem]) -> bool: ...
...
class AccountIterator(typing.Iterator):
...
class AccountUtil:
    ACCOUNT = 5
    ACCOUNT_NAME = 17
    ACCOUNT_NAME_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$1'
    ACCOUNT_TYPE_NAME_CASE_INSENSITIVE_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$$Lambda$481/0x000000080045b170'
    ACCOUNT_TYPE_NAME_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$$Lambda$480/0x000000080045aef0'
    ACTION = 10
    AMOUNT = 3
    AMOUNT_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$3'
    CATEGORY = 13
    CATEGORY_NAME = 18
    CHECKNUM = 9
    CHECKNUM_INT = 11
    ...
    DATE = 0
    DATE_ENTERED = 1
    DATE_ENTERED_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$2'
    DATE_THEN_AMOUNT = 7
    DATE_THEN_AMOUNT_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$4'
    ...
    TXN_CATEGORY_THEN_DATE_ENTERED = 'com.infinitekind.moneydance.model.AccountUtil$5'
    TXN_DATE_THEN_CHECKNUM = 'com.infinitekind.moneydance.model.AccountUtil$6'
    TXN_DESCRIPTION = 'com.infinitekind.moneydance.model.AccountUtil$8'
    TXN_TAXDATE_THEN_CHECKNUM = 'com.infinitekind.moneydance.model.AccountUtil$7'
    
    def __init__(self) -> None: ...
    
    @staticmethod
    def allMatchesForSearch(account: Account, acctFilter: 'AcctFilter') -> typing.List[Account]: ...
    ...
    @staticmethod
    def compCategoryDateAmountOtherSide(txn: Txn, txn2: Txn) -> int: ...
    ...
    @staticmethod
    def compCheckIntId(txn: Txn, txn2: Txn) -> int: ...
    ...
    @staticmethod
    def compCheckNumId(txn: Txn, txn2: Txn) -> int: ...
    
    @staticmethod
    def compCheckNumParent(txn: Txn, txn2: Txn) -> int: ...
    ...
    @staticmethod
    def compDateThenAmount(txn: Txn, txn2: Txn) -> int: ...
    
    @staticmethod
    def compDateThenAmountTxn(txn: Txn, txn2: Txn) -> int: ...
    
    @staticmethod
    def compDateThenStatus(txn: Txn, txn2: Txn) -> int: ...
    ...
    @staticmethod
    def compStatus(txn: Txn, txn2: Txn) -> int: ...
    
    @staticmethod
    def compStatusChecknum(txn: Txn, txn2: Txn) -> int: ...
    ...
    @staticmethod
    def findAllReferencesToAccount(t: typing.List[MoneydanceSyncableItem], account: Account) -> None: ...
    
    @staticmethod
    def firstMatchForSearch(account: Account, acctFilter: 'AcctFilter') -> Account: ...
    
    @staticmethod
    def getAccountIterator(account: Account) -> typing.Iterator[Account]: ...
    
    @staticmethod
    def getBalanceAsOfDate(accountBook: AccountBook, account: Account, i: int) -> int: ...
    
    @staticmethod
    def getBalancesAsOfDates(accountBook: AccountBook, account: Account, t: typing.List[int]) -> typing.List[int]: ...
    
    @staticmethod
    def getCategoryFromTxn(txn: Txn) -> Account: ...
    ...
    @staticmethod
    def getFilterExcludingInactiveAccounts(acctFilter: 'AcctFilter') -> 'AcctFilter': ...
    
    @staticmethod
    def getFilterForType(s: str) -> 'AcctFilter': ...
    
    @staticmethod
    def getInvestmentCategoryComparator(b: bool, b2: bool) -> typing.Callable[[Txn, Txn], int]: ...
    
    @staticmethod
    def getNonCategoryFromTxn(txn: Txn) -> Account: ...
    ...
    @staticmethod
    def sumBalancesByCurrency(accountBook: AccountBook, acctFilter: 'AcctFilter') -> typing.Dict['CurrencyType',int]: ...
...
class AddressBook:
    comparator = 'com.infinitekind.moneydance.model.AddressBook$1'
    
    def __init__(self, accountBook: AccountBook) -> None: ...
    
    def addEntry(self, addressBookEntry: 'AddressBookEntry') -> None: ...
    
    def getAllEntries(self) -> typing.List['AddressBookEntry']: ...
...
class Budget(MoneydanceSyncableItem):
    ...
    def calculate(self, t: typing.List['DateRange'], b: bool, b2: bool) -> str: ...
    ...
    def getAllItems(self) -> typing.List['BudgetItem']: ...
    
    def getBudgetList(self) -> 'BudgetList': ...
    
    @staticmethod
    def getIntervalIdx(t: typing.List['DateRange'], i: int) -> int: ...
    ...
    class CalculationResults:
        ...
        def getActualExpensesList(self) -> typing.List[int]: ...
        
        def getActualIncome(self, i: int) -> int: ...
        
        def getActualIncomeList(self) -> typing.List[int]: ...
        
        def getBudgetedExpenses(self, i: int) -> int: ...
        
        def getBudgetedExpensesList(self) -> typing.List[int]: ...
        
        def getBudgetedIncome(self, i: int) -> int: ...
        
        def getBudgetedIncomeList(self) -> typing.List[int]: ...
        
        def getItemList(self) -> typing.List['BudgetItemDetail']: ...
...
class BudgetItemDetail(java.lang.Comparable):
    def __init__(self, i: int, account: Account) -> None: ...
    ...
    def getActualAmounts(self) -> typing.List[int]: ...
    
    def getBudgetItems(self) -> typing.List[BudgetItem]: ...
    
    def getBudgeted(self, i: int) -> int: ...
    
    def getBudgetedAmounts(self) -> typing.List[int]: ...
...
class BudgetItemList(typing.Iterable):
    ...
    def getBudgetItemsForAccountAndInterval(self, account: Account, i: int) -> typing.List[BudgetItem]: ...
    
    def getBudgetItemsForAccountInRange(self, account: Account, dateRange: 'DateRange', t: typing.List[BudgetItem]) -> typing.List[BudgetItem]: ...
    ...
    def iterator(self) -> typing.Iterator[BudgetItem]: ...
    ...
    def toArray(self) -> typing.List[BudgetItem]: ...
...
class BudgetList:
    ...
    def getAllBudgets(self) -> typing.List[Budget]: ...
...
class BudgetPeriod:
    def __init__(self, i: int, periodType: 'PeriodType') -> None: ...
...
class CapitalGainBuy(java.lang.Comparable):
    def __init__(self, account: Account, i: int, i2: int, i3: int) -> None: ...
...
class CheckNumSettings:
    ...
    def getPopupStrings(self) -> typing.List[str]: ...
    ...
    def setPopupStrings(self, t: typing.List[str]) -> None: ...
...
class CompoundingType(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['CompoundingType']: ...
...
class CurrencyTable(typing.Iterable):
    def __init__(self, accountBook: AccountBook) -> None: ...
    ...
    def getAllCurrencies(self) -> typing.List['CurrencyType']: ...
    ...
    def iterator(self) -> typing.Iterator['CurrencyType']: ...
...
class CurrencyType(MoneydanceSyncableItem):
    ...
    def __init__(self, currencyTable: CurrencyTable) -> None: ...
    ...
    def format(self, i: int, s: str) -> str: ...
    
    def formatFancy(self, i: int, s: str) -> str: ...
    
    def formatNoDecimals(self, i: int) -> str: ...
    
    def formatSemiFancy(self, i: int, s: str) -> str: ...
    ...
    def getSnapshots(self) -> typing.List[CurrencySnapshot]: ...
    
    def getSplits(self) -> typing.List[CurrencySplit]: ...
    ...
    def parse(self, s: str, s2: str) -> int: ...
...
class CurrencyUtil:
    CURRENCY_NAME_COMPARATOR = 'com.infinitekind.moneydance.model.CurrencyUtil$1'
    CURRENCY_TYPENAME_COMPARATOR = 'com.infinitekind.moneydance.model.CurrencyUtil$2'
    ...
    @staticmethod
    def parseCurrencyExpression(s: str, s2: str, currencyType: CurrencyType, currencyTable: CurrencyTable) -> int: ...
...
class DateReminderPair(java.lang.Comparable):
    ...
    def __init__(self, i: int, reminder: 'Reminder') -> None: ...
    
    def compareTo(self, dateReminderPair: 'DateReminderPair') -> int: ...
    
    
class GenericTxnSearch(TxnSearch):
    def __init__(self, s: str, s2: str, c: com.infinitekind.util.CustomDateFormat) -> None: ...
...
class InvestFields:
    ...
    payee: str
    price: float
    secCurr: CurrencyType
    security: Account
    shares: int
    status: 'AbstractTxn.ClearedStatus'
    taxDate: int
    txnType: 'InvestTxnType'
    xfrAcct: Account
...
class InvestTxnType(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['InvestTxnType']: ...
...
class InvestUtil:
    ...
    @staticmethod
    def buildBuyTransactionList(account: Account) -> typing.List[CapitalGainBuy]: ...
    
    @staticmethod
    def computeROI(t: typing.List['ROICashFlowEntry'], f: float) -> float: ...
    ...
    @staticmethod
    def getCostBasisCapGain(account: Account, t: typing.List[CapitalGainBuy], splitTxn: 'SplitTxn') -> CapitalGainResult: ...
    ...
    @staticmethod
    def getRemainingLots(accountBook: AccountBook, account: Account, i: int) -> typing.Dict[str,AvailableSharesTracker]: ...
    
    @staticmethod
    def getSecurityBalanceInfo(account: Account, i: int, i2: int, currencyType: CurrencyType, s: str) -> str: ...
    ...
    @staticmethod
    def processLotBasedTxn(txnSet: 'TxnSet', splitTxn: 'SplitTxn', currencyType: CurrencyType, i: int, t: typing.Dict[str,AvailableSharesTracker]) -> None: ...
    
    @staticmethod
    def recomputeStartDate(t: typing.List['ROICashFlowEntry'], i: int) -> int: ...
...
class Legacy:
    ...
    @staticmethod
    def makeBasicReminder(accountBook: AccountBook, i: int, s: str, i2: int, i3: int, i4: int, t: typing.List[int], i5: int, t2: typing.List[int], i6: int, b: bool, s2: str) -> 'Reminder': ...
    ...
    @staticmethod
    def makeTransactionReminder(accountBook: AccountBook, i: int, s: str, i2: int, i3: int, i4: int, t: typing.List[int], i5: int, t2: typing.List[int], i6: int, b: bool, parentTxn: 'ParentTxn') -> 'Reminder': ...
...
class LegacyTxnTags:
    ...
    def getTagStringsForIDString(self, s: str) -> typing.List[str]: ...
    
    def getTagsForIDString(self, s: str) -> typing.List[str]: ...
    
    def getTagsForTxn(self, abstractTxn: AbstractTxn) -> typing.List[str]: ...
...
class LocalStorage(com.infinitekind.tiksync.SyncRecord, com.infinitekind.tiksync.SyncStorage):
    ...
    def writeToFileAtomically(self, t: typing.List[int], s: str) -> None: ...
...
class MediaType(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['MediaType']: ...
...
class OnlineAccountInfo:
    ...
    def getAccountSubtype(self) -> str: ...
    
    def getAccountType(self) -> str: ...
    
    def getBalance(self) -> int: ...
    
    def getBalanceAvailable(self) -> int: ...
    
    def getBalanceCurrent(self) -> int: ...
    
    def getBalanceDate(self) -> int: ...
    
    def getBalanceLimit(self) -> int: ...
    ...
    def getCurrencyIsOfficial(self) -> bool: ...
    ...
    def getMappingKey(self) -> str: ...
    
    def getOfficialName(self) -> str: ...
    
    def getPhone(self) -> str: ...
    
    def getPlaidItemID(self) -> str: ...
    
    def getRoutingNumber(self) -> str: ...
    
    def getVerificationStatus(self) -> str: ...
    ...
    def setAccountSubtype(self, s: str) -> None: ...
    
    def setAccountType(self, s: str) -> None: ...
    
    def setBalance(self, i: int) -> None: ...
    
    def setBalanceAvailable(self, i: int) -> None: ...
    
    def setBalanceCurrent(self, i: int) -> None: ...
    
    def setBalanceDate(self, i: int) -> None: ...
    
    def setBalanceLimit(self, i: int) -> None: ...
    ...
    def setCurrencyIsOfficial(self, b: bool) -> None: ...
    ...
    def setOfficialName(self, s: str) -> None: ...
    
    def setPhone(self, s: str) -> None: ...
    
    def setPlaidItemID(self, s: str) -> None: ...
    
    def setRoutingNumber(self, s: str) -> None: ...
    
    def setVerificationStatus(self, s: str) -> None: ...
    
    def toString(self) -> str: ...
    
    
class OnlineAccountMapping:
    def __init__(self, accountBook: AccountBook, onlineService: 'OnlineService') -> None: ...
    
    def dumpMappingInfo(self, j: java.io.PrintStream) -> None: ...
    
    @staticmethod
    def filterForOnlineAccountType(onlineAccountInfo: OnlineAccountInfo) -> AcctFilter: ...
    
    @staticmethod
    def findServiceReferencesToAccount(account: Account) -> typing.List['OnlineServiceLink']: ...
    
    @staticmethod
    def findUnmatchedReferences(accountBook: AccountBook, onlineService: 'OnlineService') -> typing.List[str]: ...
    
    def getAccountForOnlineID(self, s: str, account: Account) -> Account: ...
    
    def getKnownOnlineAccounts(self) -> typing.List[str]: ...
    
    @staticmethod
    def localTypesForOnlineAccountType(onlineAccountInfo: OnlineAccountInfo) -> typing.List[str]: ...
    
    @staticmethod
    def migrateFromAccountData(accountBook: AccountBook) -> None: ...
    
    def setMapping(self, s: str, account: Account) -> None: ...
    ...
    class NameAndID:
        ...
        def getAccountInfo(self) -> OnlineAccountInfo: ...
...
class OnlineInfo:
    ...
    def getAllServices(self) -> typing.List['OnlineService']: ...
...
class OnlineMailList(MoneydanceSyncableItem):
    ...
    def getAllMessages(self) -> typing.List[OnlineMail]: ...
...
class OnlinePayee(OnlinePayeeInterface, OnlineBankAcctToInterface, OnlineExtdPayeeInterface):
    ...
    def getAccountNums(self) -> typing.List[str]: ...
    ...
    def setAccountNums(self, t: typing.List[str]) -> None: ...
...
class OnlinePayeeList(MoneydanceSyncableItem):
    ...
    def getPayeesByName(self, s: str) -> typing.List[OnlinePayee]: ...
...
class OnlineService(MoneydanceSyncableItem):
    ...
    def canDownloadTransactionsForAccount(self, account: Account) -> bool: ...
    ...
    def getAvailableAccounts(self) -> typing.List[OnlineAccountInfo]: ...
    ...
    def getBankXfrProcessingDaysOff(self) -> typing.List[str]: ...
    ...
    def getBillPayProcessingDaysOff(self) -> typing.List[str]: ...
    ...
    def getInvalidAcctTypes(self) -> typing.List[str]: ...
    ...
    def getRealms(self) -> typing.List[str]: ...
    ...
    def getStopChkProcessingDaysOff(self) -> typing.List[str]: ...
    ...
    def isMoneydancePlusService(self) -> bool: ...
    ...
    def setAvailableAccounts(self, t: typing.List[OnlineAccountInfo]) -> None: ...
    ...
    def setBankXfrProcessingDaysOff(self, t: typing.List[str]) -> None: ...
    ...
    def setBillPayProcessingDaysOff(self, t: typing.List[str]) -> None: ...
    ...
    def setInvalidAcctTypes(self, t: typing.List[str]) -> None: ...
    ...
    def setServiceType(self, s: str) -> None: ...
    ...
    def setStopChkProcessingDaysOff(self, t: typing.List[str]) -> None: ...
    ...
    class Protocol:
        ...
        def compareToX(self, s: str) -> int: ...
        
        @staticmethod
        def serviceTypeForString(s: str) -> str: ...
...
class OnlineServiceLink:
    accountID: str
    onlineServiceID: str
    
    def __init__(self, s: str, s2: str, account: Account) -> None: ...
    
    def addIfUniqueAndFound(self, t: typing.List['OnlineServiceLink']) -> None: ...
    
    def getService(self) -> OnlineService: ...
...
class OnlineTxn(OnlinePayeeInterface, OnlineBankAcctToInterface, OnlineCCAcctToInterface):
    ...
    def getISOCurrencyCode(self) -> str: ...
    
    def getIncomeType(self) -> str: ...
    
    def getInvestTxnType(self) -> str: ...
    
    def getInvestmentTxnType(self) -> InvestTxnType: ...
    
    def getLoad(self) -> int: ...
    
    def getLocAddress(self) -> str: ...
    
    def getLocCity(self) -> str: ...
    
    def getLocCountry(self) -> str: ...
    
    def getLocLatitude(self) -> float: ...
    
    def getLocLongitude(self) -> float: ...
    
    def getLocPostCode(self) -> str: ...
    
    def getLocRegion(self) -> str: ...
    
    def getLocStoreNumber(self) -> str: ...
    ...
    def getOriginalDescription(self) -> str: ...
    ...
    def getPaymentChannel(self) -> str: ...
    
    def getPhone(self) -> str: ...
    
    def getPlaidCategoryID(self) -> str: ...
    
    def getPmtByOrderOf(self) -> str: ...
    
    def getPmtMethod(self) -> str: ...
    
    def getPmtPPDID(self) -> str: ...
    
    def getPmtPayee(self) -> str: ...
    
    def getPmtPayer(self) -> str: ...
    
    def getPmtProcessor(self) -> str: ...
    
    def getPmtReason(self) -> str: ...
    
    def getPmtReferenceNumber(self) -> str: ...
    ...
    def getTransactionCode(self) -> str: ...
    ...
    def getUnofficialCurrencyCode(self) -> str: ...
    ...
    def resolveInvestmentTxnType(self) -> InvestTxnType: ...
    ...
    def setExtraParameter(self, s: str, s2: str) -> None: ...
    ...
    def setISOCurrencyCode(self, s: str) -> None: ...
    
    def setIncomeType(self, s: str) -> None: ...
    
    def setInvestTxnType(self, s: str) -> None: ...
    
    def setInvestmentTxnType(self, investTxnType: InvestTxnType) -> None: ...
    
    def setLoad(self, i: int) -> None: ...
    
    def setLocAddress(self, s: str) -> None: ...
    
    def setLocCity(self, s: str) -> None: ...
    
    def setLocCountry(self, s: str) -> None: ...
    
    def setLocLatitude(self, j: java.lang.Double) -> None: ...
    
    def setLocLongitude(self, j: java.lang.Double) -> None: ...
    
    def setLocPostCode(self, s: str) -> None: ...
    
    def setLocRegion(self, s: str) -> None: ...
    
    def setLocStoreNumber(self, s: str) -> None: ...
    ...
    def setMerchantName(self, s: str) -> None: ...
    ...
    def setOriginalDescription(self, s: str) -> None: ...
    ...
    def setPaymentChannel(self, s: str) -> None: ...
    
    def setPending(self, b: bool) -> None: ...
    
    def setPhone(self, s: str) -> None: ...
    
    def setPlaidCategoryID(self, s: str) -> None: ...
    
    def setPmtByOrderOf(self, s: str) -> None: ...
    
    def setPmtMethod(self, s: str) -> None: ...
    
    def setPmtPPDID(self, s: str) -> None: ...
    
    def setPmtPayee(self, s: str) -> None: ...
    
    def setPmtPayer(self, s: str) -> None: ...
    
    def setPmtProcessor(self, s: str) -> None: ...
    
    def setPmtReason(self, s: str) -> None: ...
    
    def setPmtReferenceNumber(self, s: str) -> None: ...
    ...
    def setTransactionCode(self, s: str) -> None: ...
    
    def setTransactionType(self, s: str) -> None: ...
    
    def setTransferDirection(self, s: str) -> None: ...
    
    def setTransferDirectionFromAmount(self) -> None: ...
    
    def setTxnType(self, s: str) -> None: ...
    
    def setUnofficialCurrencyCode(self, s: str) -> None: ...
...
class OnlineTxnList(MoneydanceSyncableItem):
    ...
    def getMostRecentTxnUpdate(self) -> int: ...
    
    def getOFXLastTxnUpdate(self, s: str) -> int: ...
    ...
    def resetLastUpdateDate(self, s: str) -> None: ...
    
    def resetLastUpdateDates(self) -> None: ...
...
class PeriodType(java.lang.Enum):
    ...
    @staticmethod
    def all() -> typing.List['PeriodType']: ...
    
    @staticmethod
    def filter(periodType: 'PeriodType', periodTypeFilter: 'PeriodTypeFilter') -> typing.List['PeriodType']: ...
    ...
    @staticmethod
    def values() -> typing.List['PeriodType']: ...
    
    
class PeriodTypeFilter:
    FILTER_LARGER = 'com.infinitekind.moneydance.model.PeriodTypeFilter$LargerPeriodTypeFilter'
    FILTER_LARGER_OR_EQUAL = 'com.infinitekind.moneydance.model.PeriodTypeFilter$LargerPeriodTypeFilter'
    FILTER_NARROWER = 'com.infinitekind.moneydance.model.PeriodTypeFilter$NarrowerPeriodTypeFilter'
    FILTER_NARROWER_OR_EQUAL = 'com.infinitekind.moneydance.model.PeriodTypeFilter$NarrowerPeriodTypeFilter'
    
    def __init__(self) -> None: ...
    
    def filter(self, periodType: PeriodType) -> typing.List[PeriodType]: ...
...
class ROICashFlowEntry(java.lang.Comparable):
    def __init__(self, i: int, i2: int, currencyType: CurrencyType, i3: int) -> None: ...
...
class RateAdjustmentOption(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['RateAdjustmentOption']: ...
...
class Reminder(MoneydanceSyncableItem):
    ...
    def getPastDueDates(self, j: java.util.Calendar) -> typing.List[java.util.Date]: ...
    ...
    def getRepeatMonthly(self) -> typing.List[int]: ...
    
    def getRepeatMonthlyModifier(self) -> int: ...
    
    def getRepeatWeeklyDays(self) -> typing.List[int]: ...
    ...
    def setRepeatMonthly(self, i: int, t: typing.List[int]) -> None: ...
    
    def setRepeatWeekly(self, i: int, t: typing.List[int]) -> None: ...
...
class ReminderSet:
    ...
    def getAllReminders(self) -> typing.List[Reminder]: ...
    
    def getEventsInDay(self, j: java.util.Calendar) -> typing.List[Reminder]: ...
    
    def getOverdueItems(self, j: java.util.Calendar) -> typing.List[DateReminderPair]: ...
    
    def getRemindersOnDay(self, j: java.util.Calendar) -> typing.List[Reminder]: ...
...
class ReportSpecManager:
    ...
    def getAllGraphs(self) -> typing.List[ReportSpec]: ...
    
    def getAllItems(self) -> typing.List[ReportSpec]: ...
    
    def getAllMemorizedItems(self) -> typing.List[ReportSpec]: ...
    
    def getAllReports(self) -> typing.List[ReportSpec]: ...
    
    def getMemorizedGraphs(self) -> typing.List[ReportSpec]: ...
    
    def getMemorizedItems(self, s: str, b: bool) -> typing.List[ReportSpec]: ...
    
    def getMemorizedReports(self) -> typing.List[ReportSpec]: ...
    
    def removeListener(self, memorizedItemListener: MemorizedItemListener) -> None: ...
    
    
class SecurityComparator(java.util.Comparator):
    def __init__(self, b: bool) -> None: ...
    
    def compare(self, txn: Txn, txn2: Txn) -> int: ...
...
class SecurityType(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['SecurityType']: ...
...
class SplitTxn(AbstractTxn):
    ...
    def __init__(self, parentTxn: ParentTxn) -> None: ...
...
class TotalAmount:
    def __init__(self, currencyType: CurrencyType) -> None: ...
...
class TransactionSet(typing.Iterable):
    def __init__(self, accountBook: AccountBook) -> None: ...
    ...
    def getFirstMatch(self, b: bool, txnSearch: TxnSearch) -> Txn: ...
    
    def getListOfTxnNodes(self, txnSearch: TxnSearch) -> typing.List[Txn]: ...
    ...
    def getTxns(self, txnSearch: TxnSearch, t: typing.Sequence[Txn]) -> typing.Sequence[Txn]: ...
    
    def getTxnsForAccount(self, account: Account) -> typing.List[AbstractTxn]: ...
    
    def hasTxnsForAccount(self, account: Account) -> bool: ...
    
    def isDirty(self) -> bool: ...
    
    def iterableTxns(self) -> typing.Iterable[AbstractTxn]: ...
    
    def iterator(self) -> typing.Iterator[AbstractTxn]: ...
    
    def loadTxn(self, parentTxn: ParentTxn) -> None: ...
    
    def matchPayee(self, account: Account, s: str, b: bool, i: int) -> typing.List[ParentTxn]: ...
    
    def matchSplitPayee(self, account: Account, s: str, b: bool, i: int) -> typing.List[SplitTxn]: ...
...
class TxnIterator(typing.Iterator):
    def __init__(self, transactionSet: TransactionSet) -> None: ...
...
class TxnSet(typing.Iterable):
    def __init__(self) -> None: ...
    
    def addAll(self, t: typing.Sequence[AbstractTxn]) -> None: ...
    ...
    def removeAll(self, t: typing.Sequence[AbstractTxn]) -> None: ...
    ...
    def sortWithComparator(self, t: typing.Callable[[Txn, Txn], int]) -> None: ...
    
    def swap(self, i: int, i2: int) -> None: ...
    
    def toArray(self) -> typing.List[AbstractTxn]: ...
...
class TxnSortOrder(java.lang.Enum, java.util.Comparator):
    ...
    def getComparator(self) -> typing.Callable[[Txn, Txn], int]: ...
    ...
    @staticmethod
    def values() -> typing.List['TxnSortOrder']: ...
...
class TxnUtil:
    ...
    OTHER_ACCOUNT_THEN_DATE_COMPARATOR = 'com.infinitekind.moneydance.model.TxnUtil$8'
    ...
    @staticmethod
    def comparatorForField(i: int) -> typing.Callable[[Txn, Txn], int]: ...
    ...
    @staticmethod
    def getKeywordsAsString(t: typing.List[str]) -> str: ...
    
    @staticmethod
    def getListOfAllNonNumericCheckNumbers(accountBook: AccountBook, account: Account) -> typing.List[str]: ...
    
    @staticmethod
    def getListOfAllUsedTransactionTags(txnSet: TxnSet) -> typing.List[str]: ...
    ...
    @staticmethod
    def markOnlineTxnsAsOf(t: typing.Iterator[AbstractTxn], i: int, i2: int) -> None: ...
    
    @staticmethod
    def mediaTypeForFilename(s: str) -> MediaType: ...
    
    @staticmethod
    def parseCostBasisTag(splitTxn: SplitTxn) -> typing.Dict[str,int]: ...
...
class UndoManagerInterface:
    ...
    def addItems(self, t: typing.List[MoneydanceSyncableItem]) -> typing.List[MoneydanceSyncableItem]: ...
    
    def deleteItems(self, t: typing.List[MoneydanceSyncableItem]) -> None: ...
    
    def modifyItems(self, t: typing.List[MoneydanceSyncableItem], t2: typing.List[MoneydanceSyncableItem]) -> None: ...
