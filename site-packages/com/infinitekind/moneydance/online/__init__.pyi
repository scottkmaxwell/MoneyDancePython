...
class OnlineTxnMerger:
    ...
    def __init__(self, onlineBankingUI: OnlineBankingUI, c: com.infinitekind.moneydance.model.Account) -> None: ...
    ...
    def mergeTransactionsIntoRegister(self, t: typing.List[com.infinitekind.moneydance.model.OnlineTxn]) -> typing.List[com.infinitekind.moneydance.model.OnlineTxn]: ...
    ...
    class DownloadedTxnAction:
        def __init__(self, onlineTxnMerger: 'OnlineTxnMerger') -> None: ...
    ...
    class TxnCleanup:
        originalTxn: com.infinitekind.moneydance.model.AbstractTxn
        suggestedSimilarTxn: com.infinitekind.moneydance.model.AbstractTxn
        txn: com.infinitekind.moneydance.model.AbstractTxn
        
        def __init__(self, onlineTxnMerger: 'OnlineTxnMerger', c: com.infinitekind.moneydance.model.AbstractTxn, c2: com.infinitekind.moneydance.model.AbstractTxn, f: float) -> None: ...
    ...
    class TxnMatch:
        matchType: 'OnlineTxnMerger.TxnMatchType'
        onlineTxn: com.infinitekind.moneydance.model.OnlineTxn
        registerTxn: com.infinitekind.moneydance.model.AbstractTxn
        txn: com.infinitekind.moneydance.model.AbstractTxn
