...
class FileImportSpec:
    ...
    def __init__(self, s: str, c: com.infinitekind.moneydance.online.OnlineBankingUI) -> None: ...
    
    def getColumnTypes(self) -> typing.List[com.infinitekind.moneydance.model.txtimport.ImportFieldType]: ...
    ...
    def getPossibleAccountTypes(self) -> typing.List[str]: ...
    ...
    def setColumnTypes(self, t: typing.List[com.infinitekind.moneydance.model.txtimport.ImportFieldType]) -> None: ...
...
class QIFFileImporter(FileImporter):
    ...
    def getImportableAccounts(self) -> typing.Iterable[com.infinitekind.moneydance.model.Account]: ...
