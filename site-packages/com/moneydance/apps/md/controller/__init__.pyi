...
class AccountFilter:
    ...
    def addIncludedAccounts(self, c: com.infinitekind.moneydance.model.AccountBook, t: typing.List[str]) -> None: ...
    
    def buildIncludedAccountList(self, c: com.infinitekind.moneydance.model.AccountBook) -> typing.List[com.infinitekind.moneydance.model.Account]: ...
    ...
    def getAllIncluded(self) -> typing.Sequence[str]: ...
    
    def getAllIncludedCollapsed(self) -> typing.Sequence[str]: ...
    
    def getAllowedTypes(self) -> typing.Set[str]: ...
...
class AppSource:
    ...
    def getBundledExtensionIDs(self) -> typing.List[str]: ...
    ...
    def getExcludedExtensions(self) -> typing.List[str]: ...
...
class AssetTypeGroup:
    def __init__(self, s: str, c: com.infinitekind.moneydance.model.CurrencyType, i: int) -> None: ...
    
    def addAccount(self, c: com.infinitekind.moneydance.model.Account, i: int) -> None: ...
    
    def getAccountList(self) -> typing.List[com.infinitekind.moneydance.model.Account]: ...
...
class BackgroundOpsThread(AppEventListener, PreferencesListener, java.lang.Thread):
    ...
    def runOnBackgroundThread(self, j: java.lang.Runnable) -> None: ...
...
class BalanceType(java.lang.Enum, com.moneydance.apps.md.view.resources.DisplayableObject):
    ...
    @staticmethod
    def values() -> typing.List['BalanceType']: ...
...
class EditSecuritySubtypes:
    ...
    @staticmethod
    def processSubtypeEdits(c: com.infinitekind.moneydance.model.SecurityType, t: typing.List[com.moneydance.apps.md.view.gui.editlistdlg.EditStringListResult], c2: com.infinitekind.moneydance.model.Account) -> typing.List[str]: ...
    
    
class FeatureInvoker:
    def __init__(self, featureModule: 'FeatureModule', s: str, j: java.awt.Image, s2: str) -> None: ...
...
class FullAccountList:
    def __init__(self, c: com.infinitekind.moneydance.model.AccountBook, accountFilter: AccountFilter, b: bool) -> None: ...
    
    def getAccountsIDsOfType(self, s: str) -> typing.Set[str]: ...
    
    def getCount(self) -> int: ...
    
    def getFullAccountIDs(self) -> typing.Set[str]: ...
    
    def getFullAccountList(self) -> typing.List[com.infinitekind.moneydance.model.Account]: ...
...
class LicenseKeyVersion(java.lang.Enum):
    ...
    def getKeyHash(self) -> typing.List[int]: ...
    ...
    @staticmethod
    def values() -> typing.List['LicenseKeyVersion']: ...
    
    def verifyKey(self, s: str, b: bool) -> bool: ...
    
    
class LocalStorageCipher:
    def __init__(self, j: javax.crypto.SecretKey, s: str) -> None: ...
    
    @staticmethod
    def encryptionKeyFromBytesAndPassword(t: typing.List[int], t2: typing.List[str], s: str) -> javax.crypto.SecretKey: ...
    
    @staticmethod
    def generateNewMainKey(s: str) -> javax.crypto.SecretKey: ...
    
    @staticmethod
    def keyFromPassword(t: typing.List[str], s: str) -> javax.crypto.SecretKey: ...
...
class MDPlus:
    ...
    class MDPlusLicense:
        ...
        def signBytes(self, t: typing.List[int]) -> typing.List[int]: ...
    ...
    class Status:
        ...
        def getKeyPayloads(self) -> typing.Dict[str,typing.List[int]]: ...
        
        def getMessage(self) -> str: ...
        
        def getPlaidCountries(self) -> typing.List[str]: ...
        
        def getPlaidProducts(self) -> typing.List[str]: ...
        
        def getStatus(self) -> str: ...
        
        def getUserPayloads(self) -> typing.Dict[str,typing.List[int]]: ...
...
class MDWorker:
    def __init__(self, mDWorkerManager: 'MDWorkerManager') -> None: ...
...
class MDWorkerManager:
    ...
    def getWorkerIterator(self) -> typing.Iterator: ...
...
class Main(StatusMonitor, FeatureModuleContext, com.moneydance.security.SecretKeyCallback, com.moneydance.awt.JLinkListener):
    ...
    mainObj = 'com.moneydance.apps.md.controller.Main'
    ...
    def getExternalAccountEditors(self) -> typing.List[com.moneydance.apps.md.extensionapi.AccountEditor]: ...
    
    def getExternalFeatureModule(self, s: str, j: java.io.File, b: bool) -> FeatureModule: ...
    
    def getExternalViews(self) -> typing.List[com.moneydance.apps.md.view.HomePageView]: ...
    
    def getFeatureInvokers(self) -> typing.Iterator: ...
    ...
    def getLoadedModules(self) -> typing.List[FeatureModule]: ...
    ...
    def getSuppressedExtensionIDs(self) -> typing.List[str]: ...
    
    def getUI(self) -> com.moneydance.apps.md.view.MoneydanceUI: ...
    
    def getUnloadableExtensionIDs(self) -> typing.List[str]: ...
    
    def getVersion(self) -> str: ...
    
    def getWorkerManager(self) -> MDWorkerManager: ...
    
    def importQIFIntoAccount(self, c: com.infinitekind.moneydance.model.AccountBook, j: java.io.File, i: int, s: str, c2: com.infinitekind.moneydance.model.CurrencyType, c3: com.infinitekind.moneydance.model.Account, i2: int, b: bool) -> None: ...
    
    def importQIFIntoNewAccount(self, c: com.infinitekind.moneydance.model.AccountBook, j: java.io.File, i: int, s: str, c2: com.infinitekind.moneydance.model.CurrencyType, i2: int, b: bool) -> None: ...
...
class PanelSettings:
    ...
    def __init__(self, panelSettings: 'PanelSettings') -> None: ...
...
class PythonExtension(FeatureModule):
    ...
    def __init__(self, j: java.lang.ClassLoader, c: com.infinitekind.util.StreamTable, o: 'org.python.util.PythonInterpreter') -> None: ...
...
class SecuritySubtypeManager:
    def __init__(self, c: com.infinitekind.moneydance.model.AccountBook, userPreferences: 'UserPreferences', c2: com.moneydance.apps.md.view.resources.MDResourceProvider) -> None: ...
    
    def getSubTypeList(self, c: com.infinitekind.moneydance.model.SecurityType) -> typing.List[str]: ...
    
    def save(self) -> None: ...
    
    def setSubTypeList(self, c: com.infinitekind.moneydance.model.SecurityType, t: typing.List[str]) -> None: ...
    
    
class SnapshotImporter:
    def __init__(self, j: java.io.File, c: com.infinitekind.moneydance.model.CurrencyType, c2: com.infinitekind.util.CustomDateFormat, s: str) -> None: ...
