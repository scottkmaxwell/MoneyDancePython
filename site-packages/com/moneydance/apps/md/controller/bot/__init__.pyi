...
class RobotWebNode:
    ...
    def subelements(self) -> typing.List['RobotWebNode']: ...
    
    
class RobotWebPage:
    def __init__(self) -> None: ...
    
    def getHeaders(self) -> typing.Dict[str,typing.List[str]]: ...
...
class RobotWebSession:
    ...
    def getCollectedPages(self) -> typing.List[RobotWebPage]: ...
    ...
    def nodesForXPath(self, s: str) -> typing.List[RobotWebNode]: ...
