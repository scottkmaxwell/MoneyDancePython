...
class ChunkedInputStream(java.io.InputStream):
    def __init__(self, j: java.io.InputStream) -> None: ...
...
class CustomURLStreamHandlerFactory(java.net.URLStreamHandlerFactory):
    ...
    @staticmethod
    def registerHeaderOrder(s: str, t: typing.List[str]) -> None: ...
...
class HTTPURLConnectionHelper:
    ...
    def getHeaderFields(self) -> typing.Dict[str,typing.List[str]]: ...
    
    def getInputStream(self) -> java.io.InputStream: ...
    
    def getOutputStream(self) -> java.io.OutputStream: ...
    
    def getRequestProperties(self) -> typing.Dict[str,typing.List[str]]: ...
...
class Headers(list):
    ...
    def copyAndMergeFrom(self, t: typing.Dict[str,typing.List[str]]) -> 'Headers': ...
    
    def copyToMap(self) -> typing.Dict[str,typing.List[str]]: ...
    
    def getAllValues(self, s: str) -> typing.List[str]: ...
    
    def getCompactString(self) -> str: ...
    
    def getHeaderWithName(self, s: str) -> Header: ...
    
    def getHeadersExcept(self, t: typing.List[str]) -> 'Headers': ...
    ...
    def set(self, t: typing.Dict[str,typing.List[str]], b: bool) -> None: ...
...
class HttpCollectionListener:
    ...
    def getCollectionSpecs(self) -> typing.List['HttpCollectorSpec']: ...
...
class HttpURLConnectionImpl(java.net.HttpURLConnection):
    ...
    def __init__(self, j: java.net.URL, j2: java.net.Proxy, moneybotURLStreamHandlerFactory: 'MoneybotURLStreamHandlerFactory') -> None: ...
...
class LimitedInputStream(java.io.InputStream):
    def __init__(self, j: java.io.InputStream, i: int) -> None: ...
...
class MDPlusURLs(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['MDPlusURLs']: ...
...
class OnlineConnectionMode(java.lang.Enum):
    ...
    @staticmethod
    def values() -> typing.List['OnlineConnectionMode']: ...
