...
class HelperWindow:
    def __init__(self, g: gui.MainFrame, g2: gui.AccountPanel, c: com.infinitekind.moneydance.model.AccountBook) -> None: ...
...
class ViewFactory(com.moneydance.apps.md.controller.ViewListener):
    def __init__(self, c: com.moneydance.apps.md.controller.Main, g: gui.MoneydanceGUI) -> None: ...
    
    def addInternalView(self, homePageView: HomePageView) -> None: ...
    
    def getAllViews(self) -> typing.List[HomePageView]: ...
