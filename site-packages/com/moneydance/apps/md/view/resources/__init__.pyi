...
class DisplayableChoice:
    def __init__(self, mDResourceProvider: 'MDResourceProvider', t: 'T') -> None: ...
...
class BalanceTypeChoice(DisplayableChoice):
    def __init__(self, mDResourceProvider: 'MDResourceProvider', c: com.moneydance.apps.md.controller.BalanceType) -> None: ...
...
class Resources(java.util.ResourceBundle):
    ...
    def getCheckNumberList(self, c: com.infinitekind.moneydance.model.Account) -> typing.List[str]: ...
