...
class SyncFolderConfigurer:
    ...
    def listAvailableExistingSyncFolders(self) -> typing.List[com.moneydance.apps.md.controller.sync.AbstractSyncFolder]: ...
...
class DropboxSyncConfigurer(SyncFolderConfigurer):
    ...
    def __init__(self, c: com.moneydance.apps.md.view.gui.MoneydanceGUI, c2: com.moneydance.apps.md.controller.AccountBookWrapper) -> None: ...
...
class ICloudSyncConfigurer(SyncFolderConfigurer):
    SYNC_TYPE = u'icloud_fs'
...
class SyncFolderUtil:
    ...
    @staticmethod
    def configurerForIDFromList(s: str, t: typing.List[SyncFolderConfigurer]) -> SyncFolderConfigurer: ...
    
    @staticmethod
    def getAvailableFolderConfigurers(c: com.moneydance.apps.md.view.gui.MoneydanceGUI, c2: com.moneydance.apps.md.controller.AccountBookWrapper) -> typing.List[SyncFolderConfigurer]: ...
    
    def getBestDropboxFolder(self, t: typing.List[SyncFolderConfigurer]) -> SyncFolderConfigurer: ...
    
    @staticmethod
    def getConfigurerForFile(c: com.moneydance.apps.md.view.gui.MoneydanceGUI, c2: com.moneydance.apps.md.controller.AccountBookWrapper, t: typing.List[SyncFolderConfigurer]) -> SyncFolderConfigurer: ...
