...
class MoneyBotWindow(com.moneydance.apps.md.view.gui.SecondaryFrame, java.lang.Runnable):
    pass
    
class PythonInterface(com.moneydance.apps.md.controller.bot.MoneybotInterface):
    def __init__(self, c: com.moneydance.apps.md.view.gui.MoneydanceGUI, c2: com.infinitekind.moneydance.model.AccountBook) -> None: ...
    
    def accountsWithType(self, s: str) -> typing.List[com.infinitekind.moneydance.model.Account]: ...
