...
class CompoundIterator(typing.Iterator):
    def __init__(self, t: typing.Iterator['T'], t2: typing.Iterator['T']) -> None: ...
...
class Misc:
    ...
    @staticmethod
    def addNoDuplicates(t: typing.List['T'], t2: 'T') -> bool: ...
    
    @staticmethod
    def isEqual(t: 'T', t2: 'T') -> bool: ...
    
    @staticmethod
    def isZero(t: typing.List[int], i: int) -> bool: ...
...
class Sorting:
    ...
    @staticmethod
    def sort(t: typing.List[int]) -> None: ...
...
class UiUtil:
    ...
    @staticmethod
    def runOnUIThread(j: java.lang.Runnable) -> None: ...
...
class VersionVerifierCallback:
    ...
    def userHasOldVersion(self, s: str, s2: str, t: typing.List[str]) -> None: ...
