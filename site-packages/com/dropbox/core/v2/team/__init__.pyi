...
class DbxTeamTeamRequests:
    ...
    def membersAddJobStatusGetV2(self, s: str) -> 'MembersAddJobStatusV2Result': ...
    
    def membersAddV2(self, t: typing.List['MemberAddV2Arg']) -> 'MembersAddLaunchV2Result': ...
    
    def membersDeleteProfilePhoto(self, userSelectorArg: 'UserSelectorArg') -> 'TeamMemberInfo': ...
    
    def membersDeleteProfilePhotoV2(self, userSelectorArg: 'UserSelectorArg') -> 'TeamMemberInfoV2Result': ...
    
    def membersGetAvailableTeamMemberRoles(self) -> 'MembersGetAvailableTeamMemberRolesResult': ...
    
    def membersGetInfo(self, t: typing.List['UserSelectorArg']) -> typing.List['MembersGetInfoItem']: ...
    
    def membersGetInfoV2(self, t: typing.List['UserSelectorArg']) -> 'MembersGetInfoV2Result': ...
    ...
    def membersListContinueV2(self, s: str) -> 'MembersListV2Result': ...
    
    def membersListV2(self) -> 'MembersListV2Result': ...
    
    def membersListV2Builder(self) -> 'MembersListV2Builder': ...
    ...
    def membersSetAdminPermissionsV2(self, userSelectorArg: 'UserSelectorArg') -> 'MembersSetPermissions2Result': ...
    ...
    def membersSetProfilePhotoV2(self, userSelectorArg: 'UserSelectorArg', c: com.dropbox.core.v2.account.PhotoSourceArg) -> 'TeamMemberInfoV2Result': ...
    
    def membersSetProfileV2(self, userSelectorArg: 'UserSelectorArg') -> 'TeamMemberInfoV2Result': ...
    
    def membersSetProfileV2Builder(self, userSelectorArg: 'UserSelectorArg') -> 'MembersSetProfileV2Builder': ...
    ...
    def sharingAllowlistAdd(self) -> 'SharingAllowlistAddResponse': ...
    
    def sharingAllowlistAddBuilder(self) -> 'SharingAllowlistAddBuilder': ...
    
    def sharingAllowlistList(self) -> 'SharingAllowlistListResponse': ...
    
    def sharingAllowlistListContinue(self, s: str) -> 'SharingAllowlistListResponse': ...
    
    def sharingAllowlistRemove(self) -> 'SharingAllowlistRemoveResponse': ...
    
    def sharingAllowlistRemoveBuilder(self) -> 'SharingAllowlistRemoveBuilder': ...
...
class MemberAddArgBase:
    ...
    class Builder:
        ...
        def build(self) -> 'MemberAddArgBase': ...
...
class MemberAddV2Arg(MemberAddArgBase):
    ...
    def getRoleIds(self) -> typing.List[str]: ...
    ...
    class Builder:
        ...
        def withRoleIds(self, t: typing.List[str]) -> str: ...
...
class MemberAddV2Result:
    ...
    @staticmethod
    def duplicateExternalMemberId(s: str) -> 'MemberAddV2Result': ...
    
    @staticmethod
    def duplicateMemberPersistentId(s: str) -> 'MemberAddV2Result': ...
    
    def equals(self, o: object) -> bool: ...
    
    @staticmethod
    def freeTeamMemberLimitReached(s: str) -> 'MemberAddV2Result': ...
    ...
    def getSuccessValue(self) -> 'TeamMemberInfoV2': ...
    ...
    @staticmethod
    def persistentIdDisabled(s: str) -> 'MemberAddV2Result': ...
    
    @staticmethod
    def success(teamMemberInfoV2: 'TeamMemberInfoV2') -> 'MemberAddV2Result': ...
    
    def tag(self) -> str: ...
    
    @staticmethod
    def teamLicenseLimit(s: str) -> 'MemberAddV2Result': ...
    ...
    @staticmethod
    def userAlreadyOnTeam(s: str) -> 'MemberAddV2Result': ...
    
    @staticmethod
    def userAlreadyPaired(s: str) -> 'MemberAddV2Result': ...
    
    @staticmethod
    def userCreationFailed(s: str) -> 'MemberAddV2Result': ...
    
    @staticmethod
    def userMigrationFailed(s: str) -> 'MemberAddV2Result': ...
    
    @staticmethod
    def userOnAnotherTeam(s: str) -> 'MemberAddV2Result': ...
...
class MembersAddJobStatusV2Result:
    ...
    @staticmethod
    def complete(t: typing.List[MemberAddV2Result]) -> 'MembersAddJobStatusV2Result': ...
    
    def equals(self, o: object) -> bool: ...
    
    @staticmethod
    def failed(s: str) -> 'MembersAddJobStatusV2Result': ...
    
    def getCompleteValue(self) -> typing.List[MemberAddV2Result]: ...
...
class MembersAddLaunchV2Result:
    ...
    @staticmethod
    def asyncJobId(s: str) -> 'MembersAddLaunchV2Result': ...
    
    @staticmethod
    def complete(t: typing.List[MemberAddV2Result]) -> 'MembersAddLaunchV2Result': ...
...
class MembersGetAvailableTeamMemberRolesResult:
    def __init__(self, t: typing.List['TeamMemberRole']) -> None: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getRoles(self) -> typing.List['TeamMemberRole']: ...
...
class MembersGetInfoItemV2:
    ...
    def getMemberInfoValue(self) -> 'TeamMemberInfoV2': ...
    
    def hashCode(self) -> int: ...
    
    @staticmethod
    def idNotFound(s: str) -> 'MembersGetInfoItemV2': ...
    ...
    @staticmethod
    def memberInfo(teamMemberInfoV2: 'TeamMemberInfoV2') -> 'MembersGetInfoItemV2': ...
...
class MembersGetInfoV2Result:
    def __init__(self, t: typing.List[MembersGetInfoItemV2]) -> None: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getMembersInfo(self) -> typing.List[MembersGetInfoItemV2]: ...
...
class MembersListV2Builder:
    def __init__(self) -> None: ...
    
    def start(self) -> 'MembersListV2Result': ...
    
    def withIncludeRemoved(self, b: bool) -> 'MembersListV2Builder': ...
    
    def withLimit(self, i: int) -> 'MembersListV2Builder': ...
    
    
class MembersListV2Result:
    def __init__(self, t: typing.List['TeamMemberInfoV2'], s: str, b: bool) -> None: ...
    ...
    def getMembers(self) -> typing.List['TeamMemberInfoV2']: ...
...
class MembersSetPermissions2Error(java.lang.Enum):
    ...
    @staticmethod
    def valueOf(s: str) -> 'MembersSetPermissions2Error': ...
    
    @staticmethod
    def values() -> typing.List['MembersSetPermissions2Error']: ...
    
    
class MembersSetPermissions2ErrorException('com.dropbox.core.DbxApiException'):
    errorValue: MembersSetPermissions2Error
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', membersSetPermissions2Error: MembersSetPermissions2Error) -> None: ...
...
class MembersSetProfileV2Builder:
    ...
    def start(self) -> 'TeamMemberInfoV2Result': ...
    
    def withNewEmail(self, s: str) -> 'MembersSetProfileV2Builder': ...
    
    def withNewExternalId(self, s: str) -> 'MembersSetProfileV2Builder': ...
    
    def withNewGivenName(self, s: str) -> 'MembersSetProfileV2Builder': ...
    
    def withNewIsDirectoryRestricted(self, b: bool) -> 'MembersSetProfileV2Builder': ...
    
    def withNewPersistentId(self, s: str) -> 'MembersSetProfileV2Builder': ...
    
    def withNewSurname(self, s: str) -> 'MembersSetProfileV2Builder': ...
...
class SharingAllowlistAddBuilder:
    ...
    def start(self) -> 'SharingAllowlistAddResponse': ...
    
    def withDomains(self, t: typing.List[str]) -> 'SharingAllowlistAddBuilder': ...
    
    def withEmails(self, t: typing.List[str]) -> 'SharingAllowlistAddBuilder': ...
    
    
class SharingAllowlistAddError:
    NO_ENTRIES_PROVIDED = '"no_entries_provided"'
    OTHER = '"other"'
    TEAM_LIMIT_REACHED = '"team_limit_reached"'
    TOO_MANY_ENTRIES_PROVIDED = '"too_many_entries_provided"'
    UNKNOWN_ERROR = '"unknown_error"'
    
    def __init__(self) -> None: ...
    
    @staticmethod
    def entriesAlreadyExist(s: str) -> 'SharingAllowlistAddError': ...
    
    def equals(self, o: object) -> bool: ...
    
    def getEntriesAlreadyExistValue(self) -> str: ...
    
    def getMalformedEntryValue(self) -> str: ...
    
    def hashCode(self) -> int: ...
    
    def isEntriesAlreadyExist(self) -> bool: ...
    
    def isMalformedEntry(self) -> bool: ...
    
    def isNoEntriesProvided(self) -> bool: ...
    
    def isOther(self) -> bool: ...
    
    def isTeamLimitReached(self) -> bool: ...
    
    def isTooManyEntriesProvided(self) -> bool: ...
    
    def isUnknownError(self) -> bool: ...
    
    @staticmethod
    def malformedEntry(s: str) -> 'SharingAllowlistAddError': ...
    ...
    class Tag:
        ENTRIES_ALREADY_EXIST = 'ENTRIES_ALREADY_EXIST'
...
class SharingAllowlistAddErrorException('com.dropbox.core.DbxApiException'):
    errorValue: SharingAllowlistAddError
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', sharingAllowlistAddError: SharingAllowlistAddError) -> None: ...
...
class SharingAllowlistListContinueError(java.lang.Enum):
    INVALID_CURSOR = 'INVALID_CURSOR'
    OTHER = 'OTHER'
    ...
    @staticmethod
    def valueOf(s: str) -> 'SharingAllowlistListContinueError': ...
    
    @staticmethod
    def values() -> typing.List['SharingAllowlistListContinueError']: ...
    
    
class SharingAllowlistListContinueErrorException('com.dropbox.core.DbxApiException'):
    errorValue: SharingAllowlistListContinueError
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', sharingAllowlistListContinueError: SharingAllowlistListContinueError) -> None: ...
...
class SharingAllowlistListErrorException('com.dropbox.core.DbxApiException'):
    errorValue: SharingAllowlistListError
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', sharingAllowlistListError: SharingAllowlistListError) -> None: ...
...
class SharingAllowlistListResponse:
    ...
    def getDomains(self) -> typing.List[str]: ...
    
    def getEmails(self) -> typing.List[str]: ...
    ...
    @staticmethod
    def newBuilder(t: typing.List[str], t2: typing.List[str]) -> str: ...
    ...
    class Builder:
        ...
        def build(self) -> 'SharingAllowlistListResponse': ...
        
        def withCursor(self, s: str) -> str: ...
        
        def withHasMore(self, b: bool) -> str: ...
...
class SharingAllowlistRemoveBuilder:
    ...
    def start(self) -> 'SharingAllowlistRemoveResponse': ...
    
    def withDomains(self, t: typing.List[str]) -> 'SharingAllowlistRemoveBuilder': ...
    
    def withEmails(self, t: typing.List[str]) -> 'SharingAllowlistRemoveBuilder': ...
...
class SharingAllowlistRemoveError:
    ...
    @staticmethod
    def entriesDoNotExist(s: str) -> 'SharingAllowlistRemoveError': ...
    
    def equals(self, o: object) -> bool: ...
    
    def getEntriesDoNotExistValue(self) -> str: ...
    
    def getMalformedEntryValue(self) -> str: ...
    
    def hashCode(self) -> int: ...
    
    def isEntriesDoNotExist(self) -> bool: ...
    ...
    @staticmethod
    def malformedEntry(s: str) -> 'SharingAllowlistRemoveError': ...
...
class SharingAllowlistRemoveErrorException('com.dropbox.core.DbxApiException'):
    errorValue: SharingAllowlistRemoveError
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', sharingAllowlistRemoveError: SharingAllowlistRemoveError) -> None: ...
...
class TeamGetInfoResult:
    ...
    def getNumUsedLicenses(self) -> int: ...
...
class TeamMemberInfoV2Result:
    def __init__(self, teamMemberInfoV2: TeamMemberInfoV2) -> None: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getMemberInfo(self) -> TeamMemberInfoV2: ...
...
class TeamMemberProfile(MemberProfile):
    ...
    class Builder:
        ...
        def withSecondaryEmails(self, l: list) -> str: ...
