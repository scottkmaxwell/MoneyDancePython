...
class AlphaResolvedVisibility(java.lang.Enum):
    NO_ONE = 'NO_ONE'
    ONLY_YOU = 'ONLY_YOU'
    OTHER = 'OTHER'
    PASSWORD = 'PASSWORD'
    ...
    @staticmethod
    def valueOf(s: str) -> 'AlphaResolvedVisibility': ...
    
    @staticmethod
    def values() -> typing.List['AlphaResolvedVisibility']: ...
...
class DbxAppGetSharedLinkMetadataBuilder:
    ...
    def withLinkPassword(self, s: str) -> 'DbxAppGetSharedLinkMetadataBuilder': ...
    
    def withPath(self, s: str) -> 'DbxAppGetSharedLinkMetadataBuilder': ...
...
class DbxAppSharingRequests:
    ...
    def getSharedLinkMetadataBuilder(self, s: str) -> DbxAppGetSharedLinkMetadataBuilder: ...
...
class DbxUserGetSharedLinkMetadataBuilder:
    ...
    def withLinkPassword(self, s: str) -> 'DbxUserGetSharedLinkMetadataBuilder': ...
    
    def withPath(self, s: str) -> 'DbxUserGetSharedLinkMetadataBuilder': ...
...
class DbxUserSharingRequests:
    ...
    def getSharedLinkMetadataBuilder(self, s: str) -> DbxUserGetSharedLinkMetadataBuilder: ...
...
class FileMemberActionResult:
    ...
    def getInvitationSignature(self) -> typing.List[str]: ...
    
    def getMember(self) -> 'MemberSelector': ...
    
    def getResult(self) -> FileMemberActionIndividualResult: ...
    
    def getSckeySha1(self) -> str: ...
    
    def hashCode(self) -> int: ...
    
    @staticmethod
    def newBuilder(memberSelector: 'MemberSelector', fileMemberActionIndividualResult: FileMemberActionIndividualResult) -> str: ...
    ...
    class Builder:
        ...
        def build(self) -> 'FileMemberActionResult': ...
        
        def withInvitationSignature(self, t: typing.List[str]) -> str: ...
        
        def withSckeySha1(self, s: str) -> str: ...
...
class LinkAudienceDisallowedReason(java.lang.Enum):
    ...
    @staticmethod
    def valueOf(s: str) -> 'LinkAudienceDisallowedReason': ...
    
    @staticmethod
    def values() -> typing.List['LinkAudienceDisallowedReason']: ...
    
    
class LinkAudienceOption:
    def __init__(self, linkAudience: LinkAudience, b: bool) -> None: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getAllowed(self) -> bool: ...
    
    def getAudience(self) -> LinkAudience: ...
    
    def getDisallowedReason(self) -> LinkAudienceDisallowedReason: ...
...
class LinkPermissions:
    def __init__(self, b: bool, t: typing.List['VisibilityPolicy'], b2: bool, b3: bool, b4: bool, b5: bool, b6: bool, b7: bool, b8: bool) -> None: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getAllowComments(self) -> bool: ...
    
    def getAllowDownload(self) -> bool: ...
    
    def getAudienceOptions(self) -> typing.List[LinkAudienceOption]: ...
    
    def getCanAllowDownload(self) -> bool: ...
    
    def getCanDisallowDownload(self) -> bool: ...
    
    def getCanRemoveExpiry(self) -> bool: ...
    
    def getCanRemovePassword(self) -> bool: ...
    
    def getCanRevoke(self) -> bool: ...
    
    def getCanSetExpiry(self) -> bool: ...
    
    def getCanSetPassword(self) -> bool: ...
    
    def getCanUseExtendedSharingControls(self) -> bool: ...
    ...
    def getRequirePassword(self) -> bool: ...
    
    def getResolvedVisibility(self) -> 'ResolvedVisibility': ...
    
    def getRevokeFailureReason(self) -> 'SharedLinkAccessFailureReason': ...
    
    def getTeamRestrictsComments(self) -> bool: ...
    
    def getVisibilityPolicies(self) -> typing.List['VisibilityPolicy']: ...
    
    def hashCode(self) -> int: ...
    
    @staticmethod
    def newBuilder(b: bool, t: typing.List['VisibilityPolicy'], b2: bool, b3: bool, b4: bool, b5: bool, b6: bool, b7: bool, b8: bool) -> str: ...
    ...
    class Builder:
        ...
        def withAudienceOptions(self, t: typing.List[LinkAudienceOption]) -> str: ...
        
        def withCanRemovePassword(self, b: bool) -> str: ...
        
        def withCanSetPassword(self, b: bool) -> str: ...
        
        def withCanUseExtendedSharingControls(self, b: bool) -> str: ...
        ...
        def withRequirePassword(self, b: bool) -> str: ...
...
class SharedLinkSettings:
    ...
    class Builder:
        ...
        def withAllowDownload(self, b: bool) -> str: ...
...
class VisibilityPolicy:
    def __init__(self, requestedVisibility: RequestedVisibility, alphaResolvedVisibility: AlphaResolvedVisibility, b: bool) -> None: ...
    
    def equals(self, o: object) -> bool: ...
    
    def getAllowed(self) -> bool: ...
    
    def getDisallowedReason(self) -> 'VisibilityPolicyDisallowedReason': ...
    
    def getPolicy(self) -> RequestedVisibility: ...
    
    def getResolvedPolicy(self) -> AlphaResolvedVisibility: ...
...
class VisibilityPolicyDisallowedReason(java.lang.Enum):
    DELETE_AND_RECREATE = 'DELETE_AND_RECREATE'
    OTHER = 'OTHER'
    PERMISSION_DENIED = 'PERMISSION_DENIED'
    RESTRICTED_BY_SHARED_FOLDER = 'RESTRICTED_BY_SHARED_FOLDER'
    ...
    @staticmethod
    def valueOf(s: str) -> 'VisibilityPolicyDisallowedReason': ...
    
    @staticmethod
    def values() -> typing.List['VisibilityPolicyDisallowedReason']: ...
