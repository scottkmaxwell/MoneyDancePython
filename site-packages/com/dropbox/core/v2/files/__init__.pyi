...
class DbxUserFilesRequests:
    ...
    def listFolderBuilder(self, s: str) -> 'ListFolderBuilder': ...
...
class ListFolderBuilder:
    ...
    def withIncludeDeleted(self, b: bool) -> 'ListFolderBuilder': ...
    
    def withIncludeHasExplicitSharedMembers(self, b: bool) -> 'ListFolderBuilder': ...
    
    def withIncludeMediaInfo(self, b: bool) -> 'ListFolderBuilder': ...
    
    def withIncludeMountedFolders(self, b: bool) -> 'ListFolderBuilder': ...
    
    def withIncludeNonDownloadableFiles(self, b: bool) -> 'ListFolderBuilder': ...
    
    def withIncludePropertyGroups(self, c: com.dropbox.core.v2.fileproperties.TemplateFilterBase) -> 'ListFolderBuilder': ...
    
    def withLimit(self, i: int) -> 'ListFolderBuilder': ...
    
    def withRecursive(self, b: bool) -> 'ListFolderBuilder': ...
    
    def withSharedLink(self, sharedLink: 'SharedLink') -> 'ListFolderBuilder': ...
...
class UploadErrorWithProperties:
    ...
    @staticmethod
    def path(uploadWriteFailed: 'UploadWriteFailed') -> 'UploadErrorWithProperties': ...
    
    @staticmethod
    def propertiesError(c: com.dropbox.core.v2.fileproperties.InvalidPropertyGroupError) -> 'UploadErrorWithProperties': ...
...
class UploadErrorWithPropertiesException('com.dropbox.core.DbxApiException'):
    errorValue: UploadErrorWithProperties
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', uploadErrorWithProperties: UploadErrorWithProperties) -> None: ...
...
class UploadSessionLookupErrorException('com.dropbox.core.DbxApiException'):
    errorValue: UploadSessionLookupError
    
    def __init__(self, s: str, s2: str, c: 'com.dropbox.core.LocalizedText', uploadSessionLookupError: UploadSessionLookupError) -> None: ...
